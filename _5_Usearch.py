...
def calculate_mpi(args):
	...
	cache_file, total_genes, mod_pos, output, per, TEMP_PATH, RND_ID, queue = args
...
def __train2_pvalue(cache_scores, cache_file, total_genes, mod_pos, output, md5):
	...
	#pvalues = __calculatePvalue(total_genes, mod_pos, output)
	#print('*****************************')
	print('[_5_USEARCH.py] *** USearch basic calculation....')
	...
	if MP_PROCESSORS <= 1:
		...
		#print('*****************************')
		print('[_5_USEARCH.py] *** P-value calculation (single process)....')
		#print('*****************************')
		...
		# multi-process
		#print('*****************************')
		print('[_5_USEARCH.py] *** P-value calculation (multiprocess)....')
		#print('*****************************')
		...
		for i in range(steps):
			args = [ cache_file, total_genes, mod_pos, output, per, TEMP_PATH, RND_ID]
...
def runFinal():
	...
	global OUTPUT_PATH, RND_ID, TEMP_PATH, P_VALUE, ITERATION, MP_PROCESSORS
